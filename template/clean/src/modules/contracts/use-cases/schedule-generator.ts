...
// Ported near-verbatim from backend/services/contracts/schedule-generator.service.ts.
// Pure date math, no injected framework dependencies — it was already
// framework-free in the original, so the port is a straight copy with the
// @Injectable() decorator dropped and the class instantiated directly by
