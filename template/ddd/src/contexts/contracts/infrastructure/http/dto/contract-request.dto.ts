...
/**
 * HTTP request DTOs — mirror the snake_case wire shape of
 * backend/dtos/contracts/contracts.dto.ts exactly, so this is a drop-in
 * replacement for API consumers. contracts.http-mapper.ts converts these
 * into the camelCase application-layer input DTOs (contract.dto.ts) that
 * use-cases actually accept.
 */
