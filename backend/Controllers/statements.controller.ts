...
import { ComputeStatementBodyDto, StatementListQueryDto } from '../DTOs/statements.dto';
...
import { StatementPage, StatementService, StatementView } from '../Services/statement.service';
...
export class StatementsController {
  ...
  list(
    ...
    @Query() query: StatementListQueryDto,
  ...
  compute(
    @CurrentAccess() access: AccessContext,
    @Body() body: ComputeStatementBodyDto,
  ...
  @Get(':id')
  @Access(Resource.Statements, Operation.Read)
  get(@CurrentAccess() access: AccessContext, @Param('id', ParseIntPipe) id: number): Promise<StatementView> {
