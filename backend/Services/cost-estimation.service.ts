...
/**
 * FR28 — fills an unrecorded month so FR2/FR4 never show a blank: the contract's own trailing
 * 3-month average when it has cost history, else the tenant's all-time cost-to-revenue ratio
 * applied to this contract's revenue for the period.
 */
@Injectable()
