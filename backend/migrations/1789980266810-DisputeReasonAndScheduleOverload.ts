...
export class DisputeReasonAndScheduleOverload1789980266810 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "shifts" ADD "dispute_reported_via" character varying(20)`);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "shifts" DROP COLUMN "dispute_reported_via"`);
